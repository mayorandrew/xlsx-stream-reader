...
XlsxStreamReaderWorkSheet.prototype.pause = function(){
	this.paused = true;
}

XlsxStreamReaderWorkSheet.prototype.resume = function(){
	this.paused = false;
	this.saxStream.emit('drain');
}
...
XlsxStreamReaderWorkSheet.prototype._handleWorkSheetStream = function(){
	...
	self.on('pipe', function (srcPipe) {
		self.saxStream = self.workBook._parseSax.call(self, srcPipe, self._handleWorkSheetNode, function(){
